<div class="modal fade" id="modalAsignarBusChofer" tabindex="-1" role="dialog" aria-labelledby="modal-default" aria-hidden="true">
            ...
            <form>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                          <div class="input-group input-group-merge">
                            <select class="form-control" data-toggle="select" onchange="changeLinea()" id="listLineaAutobuses">
